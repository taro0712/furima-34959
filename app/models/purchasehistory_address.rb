class PurchasehistoryAddress
  ...
  attr_accessor :postcode, :delivery_area_id, :city, :block, :building, :phone_number, :user_id, :product_id

  validates :postcode, :city, :block, :phone_number, :user_id, :product_id, presence: true
 ...
 def save
   ...
   Address.create( postcode: postcode, delivery_area_id: delivery_area_id, city: city, block: block, building: building, phone_number: phone_number, purchasehistory_id: purchasehistory.id )
